...
public class LauReporterDetails implements Serializable {
	...
	public void setReporterSpecialty(String reporterSpecialty) {
		this.reporterSpecialty = reporterSpecialty;
	}
	...
	public String toString() {
		StringBuffer str = new StringBuffer(LauReporterDetails.class.getName());
		str.append("[");
