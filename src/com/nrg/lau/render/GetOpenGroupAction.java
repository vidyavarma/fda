...
public class GetOpenGroupAction implements View {

	private static Logger log = Logger.getLogger(GetOpenGroupAction.class);
	...
	private String userId	= "";	
		...
		//	pw.write(readData("/getOpenGroup.do").toString());
	...
	private StringBuffer getData() {
			...
			try {
				...
				String sql 	= "{call ? := LAU_METRICS.getOpenReportsByGroup(?)}";
