...
public class GetRolesAction implements View {

	private static Logger log = Logger.getLogger(GetRolesAction.class);
	...
	public void render(Map model, HttpServletRequest request,
		...
		if (Constants.DEBUG)
			pw.write(readData("/getRoles.do").toString());
		else {
		...
		log.info("EXIT - get Roles render()");
	}
	...
	private StringBuffer getData() {
		...
		try {
			...
			String sql 	= "{call ? := LAU_UTL.getRolesdo()}";
	...
	private StringBuffer readData(String fileName) throws IOException {
		...
		URL fileURL = GetRolesAction.class.getResource(fileName);
