...
public class GetAccessibleGroupsReadAction implements View {
	
	private static Logger log = Logger.getLogger(GetAccessibleGroupsReadAction.class);
	...
	public void setDataSource(DataSource dataSource) {
		...
		this.ds = dataSource;
		log.info("GetAccessibleUsersList- Initialize db template()");
	}
	private StringBuffer getData() {
		...
		try {
			...
			String sql 	= "{call ? := lau_utl.getAccessibleGroupsPrivate(?,?)}";
