...
public class GetReservedReportListAction implements View {
	...
	public void render(Map model, HttpServletRequest request,
		...
		log.info("ENTER - ReservedReportListActionrender()");
	...
	public void setDataSource(DataSource dataSource) {
		...
		this.ds = dataSource;
		log.info("ReservedReportListAction-Initialize db template()");
	}
	private StringBuffer readData(String fileName) throws IOException {

		StringBuffer sb = new StringBuffer();
		URL fileURL = GetReservedReportListAction.class.getResource(fileName);
	...
	private StringBuffer getData() {
		...
		try {
			...
			String sql 	= "{call ? := LAU_UTL.getallreservedreportslist(?,?)}";
