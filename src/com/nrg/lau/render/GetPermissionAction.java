...
public class GetPermissionAction implements View {

	private static Logger log = Logger.getLogger(GetPermissionAction .class);
	...
	public void render(Map model, HttpServletRequest request,
		...
		log.info("ENTER - GetpERMISSIONS  render()");
		...
		log.info("EXIT - GetpERMISSIONS render()");
	}
	...
	private StringBuffer readData(String fileName) throws IOException {
		...
		URL fileURL = GetPermissionAction.class.getResource(fileName);
	...
	private StringBuffer getData() {
		...
		try {
			...
			String sql 	= "{call ? := LAU_UTL.getAllPermissions()}";
