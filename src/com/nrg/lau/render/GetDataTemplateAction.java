...
public class GetDataTemplateAction implements View {

	private static Logger log = Logger.getLogger(GetDataTemplateAction.class);
	...
	public void setDataSource(DataSource dataSource) {
		...
		this.ds = dataSource;
		log.info("get Templates -Initialize db template()");
	}
	...
	public void render(Map model, HttpServletRequest request,
		...
		log.info("ENTER - GetDataTemplateAction render()");
	...
	//	pw.write(readData("/getTemplates.do").toString());
		if (Constants.DEBUG){
			...
			pw.write(readData("/getDataTemplates.do").toString());
		}
		else {
	...
	private StringBuffer readData(String fileName) throws IOException {
		...
		reader.close();
		log.info("GetDataTemplateAction: "+sb.toString());
		return sb;
		// return sb.toString();
	}
...
private StringBuffer getData() {
		...
		try {
			...
			String sql 	= "{call ? := LAU_UTL.getDataTemplates()}";
