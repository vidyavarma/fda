...
public class GetRefListAction implements View {

	private static Logger log = Logger.getLogger(GetRefListAction .class);
   ...
   Document         document = builder.parse(new InputStream(new StringReader(xmlString)));*/
	...
	private StringBuffer readData(String fileName) throws IOException {
		...
		URL fileURL = GetRefListAction.class.getResource(fileName);
