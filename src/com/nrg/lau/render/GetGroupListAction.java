...
public class GetGroupListAction implements View {
	...
	public void render(Map model, HttpServletRequest request,
		...
		pw.write(readData("/getDepartmentList.do").toString());
		pw.flush();
		pw.close();
	...
	private StringBuffer readData(String fileName) throws IOException {
		...
		URL fileURL = GetGroupListAction.class.getResource(fileName);
