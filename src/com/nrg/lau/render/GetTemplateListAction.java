...
public class GetTemplateListAction implements View {

	private static Logger log = Logger.getLogger(GetTemplateListAction .class);
	...
	public void render(Map model, HttpServletRequest request,
		...
		log.info("ENTER - GetRefListAction  render()");
   ...
   Document         document = builder.parse(new InputStream(new StringReader(xmlString)));*/
		pw.flush();
		pw.close();
	...
	private StringBuffer readData(String fileName) throws IOException {
		...
		URL fileURL = GetTemplateListAction.class.getResource(fileName);
	...
	private StringBuffer getData() {
		...
		try {
			...
			String sql 	= "{call ? := LAU_UTL.GETREFERENCELISTSDO()}";
