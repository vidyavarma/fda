...
public class GetCheckedoutReportAction implements View {
	...
	public void render(Map model, HttpServletRequest request,
		...
		if (Constants.DEBUG)
			pw.write(readData("/getCheckoutList.do").toString());
		else
	...
	public void setDataSource(DataSource dataSource) {
		...
		this.ds = dataSource;
		log.info("Checked out list -Initialize db template()");
	}
	private StringBuffer readData(String fileName) throws IOException {

		StringBuffer sb = new StringBuffer();
		URL fileURL = GetCheckedoutReportAction.class.getResource(fileName);
	...
	private StringBuffer getData() {
		...
		try {
			...
			String sql 	= "{call ? := LAU_UTL.getReservedReportList(?,?)}";
