...
public class GetAccessibleUsersList implements View {
	
	private static Logger log = Logger.getLogger(GetAccessibleUsersList.class);
	...
	private StringBuffer getData() {
		...
		try {
			...
			String sql 	= "{call ? := lau_utl.getListOfActiveUsers(?,?)}";
