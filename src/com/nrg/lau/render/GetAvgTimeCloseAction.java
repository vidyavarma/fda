...
public class GetAvgTimeCloseAction implements View {

	private static Logger log = Logger.getLogger(GetAvgTimeCloseAction.class);
	...
	//	pw.write(readData("/getAvgTimeClose.do").toString());
...
private StringBuffer getData() {
		...
		try {
			...
			String sql 	= "{call ? := LAU_METRICS.getAvgTimeToClose(?)}";
