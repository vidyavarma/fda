...
public class GetAccessibleGroupsEditAction implements View {
	
	private static Logger log = Logger.getLogger(GetAccessibleGroupsEditAction.class);
	...
	private StringBuffer getData() {
		...
		try {
			...
			String sql 	= "{call ? := lau_utl.getAccessibleGroupsEdit(?,?)}";
