...
public class GetGroupInboxFilesAction implements View {

	private static Logger log = Logger.getLogger(GetGroupInboxFilesAction .class);
	...
	private StringBuffer readData(String fileName) throws IOException {
		...
		URL fileURL = GetGroupInboxFilesAction.class.getResource(fileName);
	...
	private StringBuffer getData() {
		...
		try {
			...
			String sql 	= "{call ? := LAU_UTL.getGroupInboxFiles(?,?)}";
