...
public class GetOpenByMonthAction implements View {

	private static Logger log = Logger.getLogger(GetOpenByMonthAction.class);
	...
	//	pw.write(readData("/getOpenByMonth.do").toString());
...
private StringBuffer getData() {
		...
		try {
			...
			String sql 	= "{call ? := LAU_METRICS.getOpenCloseStats(?)}";
