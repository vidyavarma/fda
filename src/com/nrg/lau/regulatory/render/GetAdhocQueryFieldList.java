...
public class GetAdhocQueryFieldList implements View {

	private static Logger log = Logger.getLogger(GetAdhocQueryFieldList.class);
	...
	public void render(Map model, HttpServletRequest request,
		...
		log.info("ENTER - GetAdhocQueryFieldList render()");
		...
		log.info("EXIT - GetAdhocQueryFieldList render()");
	}

	public void setDataSource(DataSource dataSource) {
		new SimpleJdbcTemplate(dataSource);
		this.ds = dataSource;
		log.info("GetAdhocQueryFieldList -Initialize db template()");
	}

	private StringBuffer readData(String fileName) throws IOException {

		StringBuffer sb = new StringBuffer();
		URL fileURL = GetAdhocQueryFieldList.class.getResource(fileName);
	...
	private StringBuffer getData() {
		...
		try {
			...
			String sql = "{call ? := LAU_UTL.getAdhocQueyFields(?)}";
