...
public class GetReportProductDevices implements View {

	private static Logger log = Logger.getLogger(GetReportProductDevices.class);
	...
	public void render(Map model, HttpServletRequest request,
		...
		String reportId = "";
		log.info("ENTER - GetReportDevices()");
		...
		log.info("EXIT - GetReportDevices()");
	}
	public void setDataSource(DataSource dataSource) {
		new SimpleJdbcTemplate(dataSource);
		this.ds = dataSource;
		log.info("Edit report list -Initialize db template()");
	}
	private StringBuffer readData(String fileName) throws IOException {

		StringBuffer sb = new StringBuffer();
		URL fileURL = GetReportProductDevices.class.getResource(fileName);
	...
	private StringBuffer getData(String reportId) {
		...
		try {
			...
			String sql 	= "{call ? := LAU_UTL.getReportProductDevices(?,?)}";
