...
public class SetQueryChartsClearFilterAction implements View {

	private static Logger log = Logger
			.getLogger(SetQueryChartsClearFilterAction.class);
	...
	public void render(Map model, HttpServletRequest request,
		...
		log.info("ENTER - SetQueryChartsClearFilterAction render()");
		...
		log.info("EXIT - SetQueryChartsClearFilterAction render()");
	}
	...
	private StringBuffer getData(HttpServletRequest request) {
		...
		try {
			...
			String sql = "{call ? := LAU_LIST.clearFilters(?)}";
		...
		log.info("---------SetQueryChartsClearFilterAction" + tmp);
		return tmp;
	}
}
