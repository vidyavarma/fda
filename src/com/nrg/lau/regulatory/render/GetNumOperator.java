...
public class GetNumOperator implements View {

	private static Logger log = Logger.getLogger(GetNumOperator.class);
	...
	public void render(Map model, HttpServletRequest request,
		...
		log.info("ENTER - GetNumOperator render()");
	...
	//	if (Constants.DEBUG)
			pw.write(readData("/getNumOperator.do").toString());
	//	else
	//		pw.write(getData().toString());	
		pw.flush();
		pw.close();

		log.info("EXIT - GetNumOperator render()");
	}
	public void setDataSource(DataSource dataSource) {
		new SimpleJdbcTemplate(dataSource);
		this.ds = dataSource;
		log.info("GetNumOperator -Initialize db template()");
	}
	private StringBuffer readData(String fileName) throws IOException {

		StringBuffer sb = new StringBuffer();
		URL fileURL = GetNumOperator.class.getResource(fileName);
