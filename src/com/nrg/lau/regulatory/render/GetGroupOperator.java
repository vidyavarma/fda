...
public class GetGroupOperator implements View {

	private static Logger log = Logger.getLogger(GetGroupOperator.class);
	...
	public void render(Map model, HttpServletRequest request,
		...
		log.info("ENTER - GetGroupOperator render()");
	...
	//	if (Constants.DEBUG)
			pw.write(readData("/getGroupOperator.do").toString());
	//	else
	//		pw.write(getData().toString());	
		pw.flush();
		pw.close();

		log.info("EXIT - GetGroupOperator render()");
	}
	public void setDataSource(DataSource dataSource) {
		new SimpleJdbcTemplate(dataSource);
		this.ds = dataSource;
		log.info("GetGroupOperator -Initialize db template()");
	}
	private StringBuffer readData(String fileName) throws IOException {

		StringBuffer sb = new StringBuffer();
		URL fileURL = GetGroupOperator.class.getResource(fileName);
