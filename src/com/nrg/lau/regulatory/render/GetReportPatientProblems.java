...
public class GetReportPatientProblems implements View {

	private static Logger log = Logger.getLogger(GetReportPatientProblems.class);
	...
	public void render(Map model, HttpServletRequest request,
		...
		log.info("ENTER -GetReportPatientProblems  render()");
		 String patientDetId = "";
		 String reportId ="";
	...
	private String getData(String patientDetId, String reportId) {
		...
		try {
			...
			String sqlStr = "'SELECT * FROM LAU_PATIENT_PROBLEM_CODES "
					+ "where report_id="
					+ reportId
