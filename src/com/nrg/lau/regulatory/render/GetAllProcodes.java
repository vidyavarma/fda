...
public class GetAllProcodes implements View {

	private static Logger log = Logger.getLogger(GetAllProcodes.class);
	...
	public void render(Map model, HttpServletRequest request,
		...
		log.info("EXIT - GetProcoderender()");
	}

	public void setDataSource(DataSource dataSource) {
		new SimpleJdbcTemplate(dataSource);
		this.ds = dataSource;
		log.info("GetProcode-Initialize db template()");
	}
...
private StringBuffer getData() {
		...
		try {
			...
			String sql 	= "{call ? := LAU_UTL.getAllProcodes()}";
