...
public class GetFilterBoxOperator implements View {

	private static Logger log = Logger.getLogger(GetFilterBoxOperator.class);
	...
	public void render(Map model, HttpServletRequest request,
		...
		log.info("ENTER - GetFilterBoxOperator render()");
	...
	//	if (Constants.DEBUG)
			pw.write(readData("/getFilterBoxOperator.do").toString());
	//	else
	//		pw.write(getData().toString());	
		pw.flush();
		pw.close();

		log.info("EXIT - GetFilterBoxOperator render()");
	}
	public void setDataSource(DataSource dataSource) {
		new SimpleJdbcTemplate(dataSource);
		this.ds = dataSource;
		log.info("GetFilterBoxOperator -Initialize db template()");
	}
	private StringBuffer readData(String fileName) throws IOException {

		StringBuffer sb = new StringBuffer();
		URL fileURL = GetFilterBoxOperator.class.getResource(fileName);
