...
public class DetachService {
	...
	private static Logger log = Logger.getLogger(DetachService.class);
	public static boolean detach(String fileid, String groupID, String caseID){
		...
		try {
			...
			"?fileid=" + fileid + "&groupid=" + groupID + "&caseid=" + caseID;
